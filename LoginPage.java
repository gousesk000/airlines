...
public class LoginPage extends JFrame
{
	...
	final Object[][] row1 = { { "Ballari", "Bangalore", "3125", "16:30" }, { "Ballari", "Chennai ", "3225", "19:00" }, { "Ballari", "Delhi", "1425 ", "08:30" }, { "Ballari", "Goa", "1025 ", "09:50" }, { "Ballari", "Hyderabad", "1525", "11:00" }, { "Ballari", "Kolkata", "3825 ", "05:30" }, { "Ballari", "Lucknow", "3025 ", "05:30" }, { "Ballari", "Mumbai", "1725", "12:00" }, { "Ballari", "Vishakapatnam", "3725", "19:00" } };
	final Object[][] row2 = { { "Ballari", "Bali", "21485", "06:20" }, { "Bangalore", "Bangkok", "9000", "20:45" }, { "Ballari", "Cairo", "22975", "10:25" }, { "Bangalore", "Vietnam", "42500", "16:45" }, { "Hyderbad", "Chicago", "35000", "06:30" }, { "Ballari", "Dubai", "12000", "08:15" }, { "Ballari", "Florida", "18500", "06:50" }, { "Bangalore", "HongKong", "20845", "12:00" }, { "Ballari", "Istanbul", "22000", "10:45" }, { "Ballari", "London", "22600", "14:35" }, { "Ballari", "Paris", "35000", "22:00" }, { "Ballari", "Melbourne", "27800", "21:15" }, { "Hyderbad", "New York", "32000", "08:50" }, { "Ballari", "Paris", "18500", "18:45" }, { "Ballari", "Rome", "19900", "20:00"}, { "Ballari", "SanFrancisco", "35000", "12:00"}, { "Bangalore", "shanghai", "24430", "10:15" }, { "Ballari", "Singapore", "9000", "21:10" }, { "Ballari", "Sydney", "27800", "12:00"}, { "Bangalore", "Toronto", "35000", "17:00 " } };
	final Object[][] row3 = { { "Ballari", "Bangalore", "9375", "16:30" }, { "Ballari", "Chennai ", "9675", "19:00" }, { "Ballari", "Delhi", "4275", "08:30" }, { "Ballari", "Goa", "3075", "09:50" }, { "Ballari", "Hyderabad", "4575", "11:00" }, { "Ballari", "Kolkata", "11475", "05:30" }, { "Ballari", "Lucknow", "9075", "05:30" }, { "Ballari", "Mumbai", "5175", "12:00" }, { "Ballari", "Vishakapatnam", "11175", "19:00" } };
	final Object[][] row4 = { { "Ballari", "Bali", "64455", "06:20" }, { "Bangalore", "Bangkok", "27000", "20:45" }, { "Ballari", "Cairo", "68925", "10:25" }, { "Bangalore", "Vietnam", "37500", "16:45" }, { "Hyderbad", "Chicago", "105000", "06:30" }, { "Ballari", "Dubai", "36000", "08:15" }, { "Ballari", "Florida", "55500", "06:50" }, { "Bangalore", "HongKong", "62535", "12:00" }, { "Ballari", "Istanbul", "66000", "10:45" }, { "Ballari", "London", "67800", "14:35" }, { "Ballari", "Paris", "105000", "22:00" }, { "Ballari", "Melbourne", "83400", "21:15" }, { "Hyderbad", "New York", "96000", "08:50" }, { "Ballari", "Paris", "55500", "18:45" }, { "Ballari", "Rome", "59700", "20:00" }, { "Ballari", "SanFrancisco", "105000", "12:00" }, { "Bangalore", "shanghai", "73290", "10:15" }, { "Ballari", "Singapore", "27000", "21:10"}, { "Ballari", "Sydney", "83400", "12:00"}, { "Bangalorel", "Toronto", "105000", "17:00" } };
...
class button1 implements ActionListener
{
	...
	String sUserCheck,sUserCheck1="user1";
	String sUserCheck2,sUserCheck2_1="user2";
	String sUserCheck3,sSudeep="Sudeep";
	...
	{
		char[] cCheck = type.TPPassword.getPassword();
		String sCheck = type.TFUserName.getText();
		if ((sCheck1.equals(sCheck)) && check(cCheck,"admin"))
		{
		...
		else if ((sUserCheck1.equals(sCheck)) && check(cCheck, "user1"))
		{
			type.PLogin.add(type.LDomesticFlight1);
			type.PLogin.add(type.LInternationalFlight1);
			type.PLogin.remove(type.LUserName);
		...
		else if ((sUserCheck2_1.equals(sCheck)) && check(cCheck, "user2"))
        {
            type.PLogin.add(type.LDomesticFlight1);
			type.PLogin.add(type.LInternationalFlight1);
			type.PLogin.remove(type.LUserName);
		...
		else if ((sSudeep.equals(sCheck)) && check(cCheck, "Sudeep"))
        {
			type.PLogin.add(type.LDomesticFlight1);
			type.PLogin.add(type.LInternationalFlight1);
			type.PLogin.remove(type.LUserName);
	...
	public boolean check(char[] cCheck, String userType)
	{
        switch (userType) {
            case "admin":
            {
                char[] cPassword={'a','d','m','i','n','\0'};
			...
			case "Sudeep":
            {
        	char[] cPassword={'S','u','d','e','e','p','\0'};
                if (cCheck.length >= 7 || cCheck.length < 6)
                    return false;
                for(int i=0;i<=5;i++)
                {
                    if(cCheck[i]!=cPassword[i])
