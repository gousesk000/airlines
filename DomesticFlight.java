...
public class DomesticFlight extends JFrame
{
	...
	public DomesticFlight(LoginPage type1)
	{
		...
		String[] sItem1={"Ballari","Bengalore","Hyderbad","Kolkata"};
		...
		BSelectDate = new JButton("Select date");
		...
		TFBookingDate=new JFormattedTextField(dateFormatter);
		...
		BSelectDate.setBounds(100,160,100,20);
			...
			public void actionPerformed(ActionEvent e) {
				...
				OKButton.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
						TFBookingDate.setText(dateFormat.format(selectedDate));
						calendarFrame.dispose();
					}
				});
				calendarFrame.getContentPane().add(dateChooser, BorderLayout.CENTER);
				calendarFrame.getContentPane().add(OKButton, BorderLayout.SOUTH);
				calendarFrame.pack();
		...
		LPassengerDetails.setBounds(50,3,100,20);
		LAdult.setBounds(55,40,100,20);
		CBAdult.setBounds(140,40,100,20);
		LChildren.setBounds(50,105,100,20);
		CBChildren.setBounds(140,105,100,20);
		LInfant.setBounds(50,170,100,20);
		CBInfant.setBounds(150,170,100,20);
		LImg2.setBounds(20,200,320,200);
		LNotes.setBounds(50,220,380,180);
...
class button3 implements ActionListener
{
    ...
    SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
    try {
        Date enteredDate = dateFormat.parse(sBookingDate);
        if (enteredDate.before(date)) {
            JOptionPane.showMessageDialog(null, "Please enter a valid date (present or future)");
            return;
        }
